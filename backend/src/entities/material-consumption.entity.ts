...
@Unique('uq_material_consumption_tenant_number', ['tenantId', 'consumptionNumber'])
export class MaterialConsumption extends TenantScopedEntity {
  ...
  @Column({
    type: 'jsonb',
    nullable: true,
    comment: 'Consumption details and specifications',
  })
  ...
  get isFullyConsumed(): boolean {
    return this.status === ConsumptionStatus.CONSUMED;
  }
}
